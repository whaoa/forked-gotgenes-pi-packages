...
| Observation | `record-observer.ts`, `notification.ts`, `notification-state.ts`, `renderer.ts`, `subagent-events-observer.ts`, `composite-subagent-observer.ts`                                                                                                                               | 6       | Session-event stats, completion nudges, notification rendering, lifecycle-event emission, multi-observer fan-out                                                                                                                                                                          |
| Tools       | `tools/`                                                                                                                                                                                                                                                                       | 8       | LLM-facing tools: Agent, get_subagent_result, steer_subagent, spawn-config, result-renderer, helpers                                                                                                                                                                                      |
| UI          | `ui/`                                                                                                                                                                                                                                                                          | 11      | Widget, creation wizard, config editor, display helpers, session navigation, settings command                                                                                                                                                                                             |
